...
double f(double x);
double method_hord(double x1);
double method_hord(double x2);
double method_hord(double eps);
double method_hord(int N);
double method_hord (int variant);
double method_of_halving(double x10);
double method_of_halving(double x2);
double method_of_halving(double eps);
double method_of_halving(int N);
double method_of_halving(int variant);
...
double method_of_halving(double x1);
double method_of_halving(double x2);
double method_of_halving(double eps);
double method_of_halving(int N);
double method_of_halving(int variant);
